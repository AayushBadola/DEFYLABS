    ...
    <div className="min-h-screen pt-20 relative overflow-hidden">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <Button 
            size="lg"
            className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white hover:shadow-lg hover:shadow-purple-500/25 px-8 py-6 transition-all duration-300"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            {processSteps.map((step) => (
              <div key={step.step} className="text-center group relative z-10">
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mx-auto group-hover:scale-105 transition-all duration-300 relative z-20 border-4 border-white dark:border-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={item.title} className="group transition-all duration-500 border-0 hover:scale-105 hover:shadow-xl">
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-all duration-300">
